...
SECRET_KEY = 'django-insecure-#2w_^fo2l&j#n8=k0w+3nkl3j4agr*kx3+818)2oh-1*j4l_76'
...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": "apps/event_default.jpg",

    # Logo to use for your site, must be present in static files, used for login form logo (defaults to site_logo)
    "login_logo": "apps/event_default.jpg",
    ...
    "welcome_sign": "Welcome to the Iticket",

    # Copyright on the footer
    "copyright": "Acme Iticket Ltd",
...
EMAIL_PORT = 465
EMAIL_USE_SSL = True
EMAIL_HOST_USER = 'aralovjavoxir@gmail.com'
EMAIL_HOST_PASSWORD = 'octvbjrhslqxveel'
